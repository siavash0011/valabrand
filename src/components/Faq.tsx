...
const Faq = () => {
  const faqs = [
    {
      question: 'برنامه و پروپزال فرایند سئو سایت رو میتونم داشته باشم؟',
      answer:
    ...
    {
      question: 'تبلیغات گوگل ادز به چه صورته ؟',
      answer:
    ...
    {
      question: 'تولید محتوا سئو شده است؟',
      answer:
    ...
    {
      question: 'طراحی سایت برای بیزنس چظور انجام میشه ؟',
      answer:
    ...
    {
      question: "خدمات امنیت سایت و شبکه هم ارائه میشه؟",
      answer:
        'ما ضمانت بازگشت وجه ۱۴ روزه برای پلن‌های ماهانه داریم. اگر در ۱۴ روز اول راضی نبودید، کل مبلغ را بدون پرسش بازمی‌گردانیم.',
    },
  ];
